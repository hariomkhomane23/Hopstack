...
public class Student_Attendance extends AppCompatActivity {
    ...
    private static final String TAG = "Student_Attendance";
    ...
    private void fetchAttendance(String email) {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Log.d(TAG, "Total Attendance Records: " + dataSnapshot.getChildrenCount());

                if (!dataSnapshot.exists()) {
                    Toast.makeText(Student_Attendance.this, "No attendance records found", Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                    return;
                }
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(Student_Attendance.this, "Failed to load attendance", Toast.LENGTH_SHORT).show();
            }
        });
    }
}